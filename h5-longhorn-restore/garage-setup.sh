...
# module under separate development, since renamed storage-core) when this test was built --
# those must not be touched. (The operator and its `garage-operator-system` namespace were
# dropped from the production module shortly after -- see this repo's top-level README
# "Provenance".)
#
